# DEAD VARIANT (P4-halved, 2026-07-19, never submitted): pilot fractions halved to 2.5%/10% (256/1,024 rows).
# Paired seed-42 10-MLP result vs Algorithm 31: raw +0.99% (outlier +7.4%) for flops -0.18%.
